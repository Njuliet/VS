...
//
//const double u0 = 313.8396 / 4;//由于后面resize成原图的1/4所以有些参数要缩小相同倍数
//const double v0 = 190.4737 / 4;
//const double fx = 481.6309 / 4;
//const double fy = 481.5541 / 4;
//const double Tx = 84;              // 118.33;      //基线84毫米
//const double doffs = 2.3442 / 4;//像素差    缺   // 代表两个相机主点在x方向上的差距, doffs = |u1 - u0|  分别是两个摄像头标定得到的内参中的U
//
