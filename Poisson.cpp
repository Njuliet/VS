////https://blog.csdn.net/xuezhisdc/article/details/51034189
////有传参的代码例子
////点的类型的头文件
...
//	//if (ext == extply){
//	//	if (pcl::io::loadPCDFile("dragonUpRight_transformed_icp.pcd", *cloud) == -1){
...
//
//	//保存网格图
//	pcl::io::savePLYFile("poisson.ply", mesh);
//
//	// 显示结果图
